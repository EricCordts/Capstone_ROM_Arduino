...
#define betaDef     1.3f        	// 2 * proportional gain  0.1
#define twoKpDef	(2.0f * 30.0f)	// 2 * proportional gain  0.5
#define twoKiDef	(2.0f * 0.6f)	// 2 * integral gain  0.0
