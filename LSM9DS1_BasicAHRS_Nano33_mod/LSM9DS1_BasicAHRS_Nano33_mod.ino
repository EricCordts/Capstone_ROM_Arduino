...
// See LSM9DS1 Register Map and Descriptions, http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/DM00103319.pdf 
//
...
{  
  ...
  if (delt_t > 500) { // update LCD once per half-second independent of read rate
    ...
    pitch *= 180.0f / PI;
    yaw   *= 180.0f / PI; 
    yaw   -= -14.27f; // Declination at Boston, Massachusetts is ~13.27 degrees on 2022-02-03
    roll  *= 180.0f / PI;
